...
public class OxygenHistogramViewUtil extends SurfaceView implements SurfaceHolder.Callback, Runnable {
	...
	public static volatile Handler	oxHistogramHandler;					// 柱状图Handler
	...
	public OxygenHistogramViewUtil(Context context, AttributeSet attrs, int twidth, int theight) {
		super(context, attrs);
		width = twidth;
		height = theight;
		...
		oxHistogramHandler = new Handler() {
			...
			public void handleMessage(Message msg) {
				...
				while (index1 < length) {
					...
					wave_int[i_wave_data] = Integer.valueOf(wave_str[i_wave_data]);
					index1 = index2 + 1;
					i_wave_data++;
				}
	...
	private void Refresh() {
		...
		if (backRect == null) {
			...
			backRect = new Rect(canvasLeft, canvasTop, canvasRight, canvasBottom);
		}
